...
function find_airline( $departure, $destination, $ordered_by, $ordered_how ) {
  return
    "select * from (select a1.code as 's1', f1.flight_number as 'first_flight',
           ...
           TIMEDIFF( ADDTIME(f1.arrival_date , -a2.timezone),
             ADDTIME(f1.departure_date, -a1.timezone)) as 'flight_time',
  ...
  UNION
    select a1.code as 's1', f1.flight_number as 'first_flight',
           ...
           f1.departure_date as departure_date, f2.arrival_date as arrival_date,
           ADDTIME(
             TIMEDIFF( ADDTIME(f1.arrival_date , -a2.timezone),
  ...
  UNION
    select a1.code as 's1', f1.flight_number as 'first_flight',
           ...
           f1.departure_date as departure_date, f3.arrival_date as arrival_date,
           ADDTIME( ADDTIME(
             TIMEDIFF( ADDTIME(f1.arrival_date , -a2.timezone ),
               ADDTIME(f1.departure_date, -a1.timezone )),
             TIMEDIFF( ADDTIME(f2.arrival_date , -a3.timezone ),
             ...
             TIMEDIFF( ADDTIME(f3.arrival_date , -a4.timezone ),
               ADDTIME(f3.departure_date, -a3.timezone ))) as 'flight_time',
           ADDTIME(
