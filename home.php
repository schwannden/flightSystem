...
_HTML;
    ...
    <div id="col1"><a href="favorite.php"><img src="http://chineseaca.pic6.eznetonline.com/upload/document_list-512_cFin.png" alt="Graduate Work Image" width="251" height="251" />
      </a><div id="text">
      <h1><a href="favorite.php">My Favorite</a></h1>
    </div></div>
  </div>
  </div></div>
